...
export const Card = ({ onPress }: Props) => {
  return (
    <TouchableOpacity
      onPress={onPress}
      className='flex flex-1 w-full mt-4 px-3 py-4 bg-white/90 rounded-lg shadow-lg shadow-black-100/70 relative'
    >
      ...
      <View className='flex flex-col mt-2'>
        ...
        <Text className='text-xs font-rubik text-black-200'>Plot 246, Ikota Villa, Lekki</Text>
